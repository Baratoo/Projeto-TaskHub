...
begin
  ...
  updatedTask.Descricao := 'Descrição2';
  ...
  Ffrm_tarefas.FDQ_Tarefas.Open;
  CheckEquals(updatedTask.Titulo, Ffrm_tarefas.FDQ_Tarefas.FieldByName('titulo').AsString, 'O titulo não foi atualizado');
  CheckEquals(updatedTask.Descricao, Ffrm_tarefas.FDQ_Tarefas.FieldByName('descricao').AsString, 'A descrição não foi atualizada');
